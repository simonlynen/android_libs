...
public abstract class AGASTdroidViewBase extends SurfaceView implements SurfaceHolder.Callback, Runnable {
    ...
    public AGASTdroidViewBase(Context context) {
        super(context);
        mHolder = getHolder();
    ...
    public void surfaceCreated(SurfaceHolder holder) {
        ...
        mCamera.setPreviewCallbackWithBuffer(new PreviewCallback() {
            public void onPreviewFrame(byte[] data, Camera camera) {
                synchronized (AGASTdroidViewBase.this) {
                    System.arraycopy(data, 0, mFrame, 0, data.length);
                    AGASTdroidViewBase.this.notify(); 
                }
